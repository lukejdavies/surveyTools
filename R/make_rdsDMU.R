...
#' @param cat data.frame of catalogue data to add to DMU. Column names should be correct for your DMU file.
...
#' @param add list of additional sublists you wish to be added to the DMU. 
...
#README<-c('The is a README that describes this table.')
